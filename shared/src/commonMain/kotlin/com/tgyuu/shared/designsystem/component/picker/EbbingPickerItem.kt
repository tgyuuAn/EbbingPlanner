package com.tgyuu.shared.designsystem.component.picker
...
fun EbbingPickerItem(
    ...
    val itemHeightDp = with(density) { itemHeightPixels.toDp() }
    ...
    val totalItemHeightPx = with(density) { totalItemHeight.toPx() }
