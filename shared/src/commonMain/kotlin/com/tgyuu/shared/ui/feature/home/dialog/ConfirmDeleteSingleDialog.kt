...
import ebbingplanner.shared.generated.resources.home_delete_single_confirm_prefix
import ebbingplanner.shared.generated.resources.home_delete_single_sub
...
internal fun ConfirmDeleteSingleDialog(
    ...
    EbbingDialog(
        dialogTop = {
            val deletePrefix = stringResource(Res.string.home_delete_single_confirm_prefix, schedule.title)
            ...
            EbbingDialogDefaultTop(
                ...
                subText = stringResource(Res.string.home_delete_single_sub)
            )
        },
        dialogBottom = {
            EbbingDialogBottom(
